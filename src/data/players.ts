...
const players: Player[] = [
  ...
  },
  {
    ...
    role: 'Support',
    game: 'CS2, FIFA',
    bio: 'El hombre que abre las puertas. Surge entra primero en cada ronda, creando espacio para el equipo. Se suma a los calentones.',
  ...
  },
  {
    ...
    role: 'Lurker',
    game: 'R6, CS2, TFT, FIFA, COD, Minecraft',
  ...
  },
  {
    ...
    role: 'AWPer',
    game: 'R6, CS2, FIFA, COD',
    bio: 'No sabe bien dónde está, no sabe bien qué hacer, pero si algo se le cruza por la mira, está muerto. Su AIM compensa años de desorientación táctica.',
  ...
  },
  {
    ...
    role: 'Sentinel',
    game: 'R6, CS2, Battlefield, COD',
    bio: 'Tiene el cerebro para ganar cualquier round y el corazón para cagarse en el momento crítico. Su análisis pre-ronda es impecable; su ejecución bajo presión, otra historia.',
